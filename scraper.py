...
url_dict = {}
blacklist = {"calendar", "portal", "apply", "admin", "password", "contact", "~", "jgarcia", "people", "event", 'tutoring', "wiki", "hpi", "aiml"} #terms in url that flag that you should not crawl them
